...
/**
 * Implementation of the lib.sec_struct.Nussinov algorithm for RNA secondary structure prediction
...
public class Nussinov {
    ...
    /**
     * construct and fill the DP matrix using the lib.sec_struct.Nussinov algorithm
     */
