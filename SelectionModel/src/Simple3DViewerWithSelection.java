...
public class Simple3DViewerWithSelection extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final SubScene subScene=new SubScene(world3D,1000,640,true,SceneAntialiasing.BALANCED);
        ...
        final Scene scene=new Scene(stackPane,1000,640);
        ...
        // add mouse handling
        MouseHandler.addMouseHandlerToScene(scene, cameraRotateX, cameraRotateY, cameraTranslate);
        ...
        for(int i=0;i<shapes.length;i++) {
            ...
            shapes[i].onMouseClickedProperty().set(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent event) {
                    shapes[index].setMaterial(new PhongMaterial(Color.BLACK));
                }
            });
